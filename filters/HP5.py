...
class HP5:
    ...
    def process(self, input_sample):
        ...
        # Biquad section 0
        x = output - (-1.91119707 * self.z1_0) - (0.91497583 * self.z2_0)
        output = 0.95654323 * x + -1.91308645 * self.z1_0 + 0.95654323 * self.z2_0
        self.z2_0 = self.z1_0
        self.z1_0 = x
...
# filters = [HP5() for _ in range(3)]  # One filter per channel
