...
4. Turn on your NPG Lite hardware and click the "CONNECT" button on the app.
5. Check the boxes for the channels you are using, map your signals to game buttons using the dropdowns, and launch your game!
